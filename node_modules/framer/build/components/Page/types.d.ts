 ...
 * @public
 */
export declare type PageDirection = "horizontal" | "vertical";
/**
 * @public
 */
export declare type PageContentDimension = "auto" | "stretch";
/**
 * @public
 */
 ...
 * @public
 */
export declare type CustomPageEffect = (info: PageEffectInfo) => PageEffectValues;
/**
 * Information about the current effect.
 * @public
 */
export declare type PageEventHandler = (event: FramerEvent) => void;
/**
 * Information about the current effect.
 * @public
 */
