...
import "../render/types/Size.js";
/** @internal */
export function EmptyState({ title = "", description = "Click and drag the connector to any frame on the canvas →", children, size, hide, insideUserCodeComponent = false, }) {
    ...
    if (childCount !== 0)
        return null;
    return (React.createElement(FrameWithMotion, { key: "empty-state", className: "framerInternalUI-canvasPlaceholder", top: 0, left: 0, bottom: 0, right: 0, style: { position: "absolute" } },
