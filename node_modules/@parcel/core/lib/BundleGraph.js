...
class BundleGraph {
  ...
  isAssetReachableFromBundle(asset, bundle) {
    ...
    if (new (_Environment().default)(bundle.env).isIsolated() || !bundle.isSplittable || bundle.bundleBehavior === _types().BundleBehavior.isolated || bundle.bundleBehavior === _types().BundleBehavior.inline) {
      return false;
    ...
    return bundleGroups.every(bundleGroup => {
      ...
      return parentBundleNodes.every(bundleNodeId => {
        ...
        if (bundleNode.type === 'root' || bundleNode.value.bundleBehavior === _types().BundleBehavior.isolated) {
          return false;
        }
        ...
        this._graph.traverseAncestors(bundleNodeId, (nodeId, ctx, actions) => {
          ...
          if (node.type === 'bundle_group') {
            ...
            if (childBundles.some(b => b.id !== bundle.id && b.bundleBehavior !== _types().BundleBehavior.isolated && this.bundleHasAsset(b, asset))) {
              actions.skipChildren();
            }
          }
        }, ['references', 'bundle']);
  ...
  getHash(bundle) {
    ...
    for (let referencedBundle of this.getReferencedBundles(bundle)) {
      if (referencedBundle.bundleBehavior !== _types().BundleBehavior.inline) {
