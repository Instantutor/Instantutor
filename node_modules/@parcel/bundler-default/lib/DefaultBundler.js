  ...
  bundle({
    ...
    bundleGraph.traverseBundles(bundle => {
      ...
      for (let candidate of candidates) {
        ...
        if (Array.from(bundleGroups).every(group => bundleGraph.getBundlesInBundleGroup(group).filter(b => b.bundleBehavior !== 'inline').length < config.maxParallelRequests)) {
  ...
  optimize({
    ...
    for (let {
      ...
      for (let bundle of sourceBundles) {
        ...
        if (bundleGroups.every(group => bundleGraph.getBundlesInBundleGroup(group).filter(b => b.bundleBehavior !== 'inline').length < config.maxParallelRequests)) {
