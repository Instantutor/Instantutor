...
var _default = new (_plugin().Transformer)({
  async loadConfig({
    ...
    if (config.isSource) {
      ...
      isJSX = Boolean((compilerOptions === null || compilerOptions === void 0 ? void 0 : compilerOptions.jsx) || pragma || JSX_EXTENSIONS[_path().default.extname(config.searchPath)]);
    ...
    for (let dep of dependencies) {
      if (dep.kind === 'WebWorker') {
        ...
        asset.addDependency({
          ...
          meta,
          resolveFrom: dep.is_helper && !dep.specifier.endsWith('/jsx-runtime') ? __filename : undefined,
          env
        });
      }
    }
