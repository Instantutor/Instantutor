...
class Scope {
  constructor(type, parent) {
    ...
    _defineProperty(this, "names", new Set());

    _defineProperty(this, "bindings", new Map());

    _defineProperty(this, "references", new Map());

    _defineProperty(this, "parent", void 0);

    _defineProperty(this, "program", void 0);

    _defineProperty(this, "renames", new Map());

    _defineProperty(this, "inverseRenames", new Map());
