...
export type EnvironmentFeature = "esmodules" | "dynamic-import" | "worker-module" | "service-worker-module";
...
export interface BundleGraph<TBundle extends Bundle> {
  ...
  getDependencyResolution(dependency: Dependency, bundle: Bundle | null | undefined): Asset | null | undefined;
  getReferencedBundle(dependency: Dependency, bundle: Bundle): TBundle | null | undefined;
  findBundlesWithAsset(arg0: Asset): Array<TBundle>;
  findBundlesWithDependency(arg0: Dependency): Array<TBundle>;

  /** Whether the asset is already included in a compatible (regarding EnvironmentContext) parent bundle. */
  isAssetReachableFromBundle(asset: Asset, bundle: Bundle): boolean;
  findReachableBundleWithAsset(bundle: Bundle, asset: Asset): TBundle | null | undefined;
   ...
   */
  resolveSymbol(asset: Asset, symbol: Symbol, boundary: Bundle | null | undefined): SymbolResolution;
  ...
  traverse<TContext>(arg0: GraphVisitor<BundleGraphTraversable, TContext>): TContext | null | undefined;
  traverseBundles<TContext>(visit: GraphVisitor<TBundle, TContext>, startBundle: Bundle | null | undefined): TContext | null | undefined;
  getUsedSymbols(arg0: Asset | Dependency): ReadonlySet<Symbol>;
}
